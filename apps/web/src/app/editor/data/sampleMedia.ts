...
export const SAMPLE_STOCK_MEDIA: SampleMediaItem[] = [
  {
    ...
    category: "Stüdyo",
    color: "#0284C7",
    description: "4K Haber Stüdyosu ana sunucu ve video wall açısı",
  ...
  },
  {
    ...
    category: "B-Roll",
    color: "#0EA5E9",
    description: "Akşam saati yoğun şehir trafiği ve gökdelenler",
    src: "synthetic://city",
  },
  {
    id: "stock_v_breaking",
  ...
  },
  {
    ...
    category: "Müzik",
    color: "#10B981",
    description: "Dramatik yaylılar ve vurucu bas açılış teması",
